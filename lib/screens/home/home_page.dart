      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            ListElements(
                title: "Massa", listOfElements: recipe.ingredientsPaste),
            ListElements(
                title: "Cobertura", listOfElements: recipe.ingredientsTopping),
            MyTitle(
                title: "modo de preparo", icon: FontAwesomeIcons.utensilSpoon),
            ListElements(
                title: "Massa", listOfElements: recipe.preparationModePaste),
            ListElements(
                title: "Cobertura",
